 ...
 * @author Rich Schiavi
 */
public class ToolTipManager2 extends MouseAdapter implements MouseMotionListener {
    ...
    final static ToolTipManager2 sharedInstance = new BallonToolTipManager();
    ...
    protected Rectangle popupFrameRect = null;
    ...
    ToolTipManager2() {
        enterTimer = new Timer(450, new insideTimerAction());
     ...
     */
    public static ToolTipManager2 sharedInstance() {
    ...
    private void initiateToolTip(MouseEvent event) {
        ...
        // A component in an unactive internal frameanimation is sent two
     ...
     */
    protected void checkForTipChange(MouseEvent event) {
        JComponent component = (JComponent) event.getSource();
    ...
    protected int getPopupFitWidth(Rectangle popupRectInScreen, Component invoker) {
        if (invoker != null) {
            Container parent;
            for (parent = invoker.getParent(); parent != null; parent = parent.getParent()) {
                // fix internal frameanimation size bug: 4139087 - 4159012
    ...
    protected int getPopupFitHeight(Rectangle popupRectInScreen, Component invoker) {
        if (invoker != null) {
            Container parent;
            for (parent = invoker.getParent(); parent != null; parent = parent.getParent()) {
                if (parent instanceof JFrame || parent instanceof JDialog ||
