...
public class DecoratedScrollPane extends JComponent {
    ...
    public DecoratedScrollPane(JScrollPane aScrollPane) {
        ...
        theStartPoint = null;
        theScale = 0.0;
        theButton = new JButton(new AbstractAction("", ImageUtil.getImageIcon("img.png")) {
            public void actionPerformed(ActionEvent e) {
                display();
            }
        });
        theButton.setToolTipText("Scroll selection");
