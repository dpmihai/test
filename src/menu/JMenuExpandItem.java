 ...
 */
class JMenuExpandItem extends JMenuItem implements ActionListener {

    public JMenuExpandItem(int maxWidth) {
        super(new JMenuExpandIcon(maxWidth));
        addActionListener(this);
        setToolTipText("Expand");
        TooltipUtil.registerComponent(this);
    }
